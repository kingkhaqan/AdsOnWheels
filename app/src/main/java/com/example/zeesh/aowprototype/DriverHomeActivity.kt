...
import kotlinx.android.synthetic.main.app_bar_driver_home.*
...
//        }
        ...
        frags.add(OneDriverFragment())
        frags.add(TwoDriverFragment())
        val madapter = DriverFragmentAdapter(supportFragmentManager, titles, frags)
        driver_home_viewpager.adapter = madapter
    ...
    class DriverFragmentAdapter(fm: FragmentManager,val titles: ArrayList<String>,  val frags: ArrayList<Fragment>): FragmentPagerAdapter(fm) {
